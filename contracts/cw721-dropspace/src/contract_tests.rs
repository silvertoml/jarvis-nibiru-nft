...
//     let token_id = "petrify #1".to_string();
//     let token_uri = "https://www.merriam-webster.com/dictionary/1".to_string();

//     let mint_msg: ExecuteMsg<Option<Empty>, Empty> = ExecuteMsg::Mint {
//         token_id: "petrify".into(),
...
//     let start_after = Some(String::new());
//     let limit = Some(100u32);
//     println!("{:?}",contract.all_tokens(deps.as_ref(), start_after, limit));
...
//     // Mint a couple tokens (from the same owner)
//     let token_id1 = "grow #1".to_string();
//     let demeter = String::from("demeter");
//     let token_id2 = "grow #2".to_string();
//     let ceres = String::from("ceres");
//     let token_id3 = "sing #3".to_string();
